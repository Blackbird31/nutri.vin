<?php if ($iframe): ?>
    ...
    <div class="input-group shadow-sm">
        ...
        <button title="Copier le lien" class="input-group-text  border-bottom-0 rounded-bottom-0" type="button"><i class="bi bi-clipboard"></i></button>
        <a title="Ouvrir la page" class="input-group-text  border-bottom-0 rounded-bottom-0" href="/<?php echo $qrcode->getId() ?>" target="_blank"><i class="bi bi-box-arrow-up-right"></i></a>
    </div>
<?php else:?>
