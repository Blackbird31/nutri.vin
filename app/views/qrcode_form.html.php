<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
  <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page"><?php if (isset($qrcode->_id)): ?>Modification du QR Code<?php else: ?>Création d'un QR Code<?php endif; ?></li>
  </ol>
</nav>

<h2><?php if (isset($qrcode->_id)): ?>Modification du QR Code<?php else: ?>Création d'un QR Code<?php endif; ?></h2>

<div class="row">
  <div class="col-7">
      <form method="POST" id="form-edition" action="/qrcode/<?php echo $qrcode->user_id ?>/write" enctype="multipart/form-data" class="live-form">
      <?php if (isset($qrcode->_id)): ?>
          <input type="hidden" name="id" value="<?php echo $qrcode->_id; ?>" />
      <?php endif; ?>
            ...
            <div class="row">
                <div class="text-center col-sm-4 img_selector">
                    ...
                    <span style="<?php if (strpos($qrcode->image_bouteille ?? '', 'data:') === false) { echo 'display: none;'; }?>">
                        <a class="btn btn-link btn-sm" href="/qrcode/<?php echo $qrcode->user_id ?>/edit/<?php echo $qrcode->_id; ?>/img/0/delete">Supprimer</a>
                    </span>
                ...
                <div class="text-center col-sm-4 img_selector">
                    ...
                    <span style="<?php if (strpos($qrcode->image_etiquette ?? '', 'data:') === false) { echo 'display: none;'; }?>">
                        <a class="btn btn-link btn-sm" href="/qrcode/<?php echo $qrcode->user_id ?>/edit/<?php echo $qrcode->_id; ?>/img/1/delete">Supprimer</a>
                    </span>
                ...
                <div class="text-center col-sm-4 img_selector">
                    ...
                    <span style="<?php if (strpos($qrcode->image_contreetiquette ?? '', 'data:') === false) { echo 'display: none;'; }?>">
                        <a class="btn btn-link btn-sm" href="/qrcode/<?php echo $qrcode->user_id ?>/edit/<?php echo $qrcode->_id; ?>/img/2/delete">Supprimer</a>
                    </span>
