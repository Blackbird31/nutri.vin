<div class="p-3 py-4 bg-white text-center liveform_anchor">
    ...
    <div id="carrousel" class="bg-white border rounded rounded-bottom-0 shadow-sm d-flex justify-content-center">
        <img id="slide" class="mt-3 bg-white border-bottom" style="height: 200px;"
            data-liveform-name="image_bouteille" data-liveform-template="{{%s}}"
            src="<?php echo $qrcode->image_bouteille ?>" >
        <div class="position-absolute top-50 start-0" id="precedent" onClick="changeSlide(-1)"><</div>
        <div class="position-absolute top-50 start-90" id="suivant" onClick="changeSlide(1)">></div>
    </div>
...
<script>
    const slide = ["<?php echo $qrcode->image_bouteille; ?>", "<?php echo $qrcode->image_etiquette; ?>", "<?php echo $qrcode->image_contreetiquette; ?>"];
